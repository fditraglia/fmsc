...
\todo[inline]{Should have a footnote making it clear that finite-sample MSE doesn't always exist for GMM estimators. Still the AMSE is meaningful if we think of it as the limit of a sequence of trimmed quadratic loss functions, as in Hansen 2013.}
...
\todo[inline]{Stress that the gains from the FMSC can be very large in practice.}
...
\todo[inline]{Mention other papers that use the local mis-specification idea. Newey studies GMM estimation and specification testing with locally mis-specified moment conditions. Cite Schorfheide here: similar in spirit to the FIC but developed independently and covers VARs.}
...
\todo[inline]{Cite Cheng and Liao here. Similar to Hall and Peixi but Lasso-based.}
...
\todo[inline]{Cite the various pre-test and IV papers here.}
...
\todo[inline]{Also cite the Linton et al paper.}
