...
\todo[inline]{Should relate this to Andrews-style papers as well as \cite{ChengLiao}.}
\todo[inline]{Should have a footnote making it clear that finite-sample MSE doesn't always exist for GMM estimators. Still the AMSE is meaningful if we think of it as the limit of a sequence of trimmed quadratic loss functions, as in \cite{Hansen2013}}
...
\todo[inline]{Mention other papers that use the local mis-specification idea. \cite{Newey1985} studies GMM estimation and specification testing with locally mis-specified moment conditions. Cite \cite{Schorfheide2005} here: similar in spirit to the FIC but developed independently and covers VARs.}
