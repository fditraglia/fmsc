...
\begin{figure}
\centering
	\input{../OLSvsIVsim/RMSE_coarse_pi_baseline.tex}
	\caption{Caption goes here.}
\end{figure}

\begin{figure}
\centering
	\input{../OLSvsIVsim/RMSE_coarse_rho_baseline.tex}
	\caption{Caption goes here.}
\end{figure}

\begin{figure}
\centering
	\input{../OLSvsIVsim/RMSE_coarse_pi_relative_DHW.tex}
	\caption{Caption goes here.}
\end{figure}

\begin{figure}
\centering
	\input{../OLSvsIVsim/RMSE_coarse_rho_relative_DHW.tex}
	\caption{Caption goes here.}
\end{figure}

\begin{figure}
\centering
	\input{../OLSvsIVsim/RMSE_coarse_pi_relative_all.tex}
	\caption{Caption goes here.}
\end{figure}

\begin{figure}
\centering
	\input{../OLSvsIVsim/RMSE_coarse_rho_relative_all.tex}
	\caption{Caption goes here.}
\end{figure}