...
\todo[inline]{Need to spend a bit more time talking about the positive-part FMSC. Relate it to what we did in the AVG estimator. Mention that we did a simulation for choosing instruments and it was identical for larger sample sizes but provided a uniform improvement over FMSC for $N=50$. Mention that the CI performance was essentially identical to that of the plain-FMSC in the simulation experiment. Details available upon request.}
