...
Without local asymptotics, the limiting bias-variance tradeoff would be degenerate: the bias component would diverge while the variance component stabilizes.
