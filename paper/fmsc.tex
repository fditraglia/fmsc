...
\todo[inline]{Mention Lemma for CLT under local mis-spec. Conditions can undoubtedly be weakened. Merely a simple example of how to derive a CLT for these kind of models in a simple setting.}
