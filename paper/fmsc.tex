...
Besides presenting simulation results, however, we have thus far said nothing about the sampling properties of the FMSC selection procedure \emph{itself}.
...
At first blush this sounds like a serious defect, but it is in fact a blessing in disguise.
...
Because this quantity cannot typically be estimated directly, we use local mis-specification to create an asymptotic framework that mimics the finite-sample intuition that a consistent selection procedure would ignore.
In the same way,
