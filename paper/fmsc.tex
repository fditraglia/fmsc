...
\label{sec:avg}
\todo[inline]{The material in this section needs to be rearranged.}
...
\todo[inline]{Should probably give the limit distribution of the FMSC here along with the related results for the J-test statistic. Also talk about how consistent selection with J-test gives a degenerate limit dist and how this relates to the Leeb \& P\"{o}tscher stuff.}
