...
In contrast, consistent selection operates in an asymptotic environment where this tradeoff is \emph{degenerate}: the bias component diverges while the variance component does not.
