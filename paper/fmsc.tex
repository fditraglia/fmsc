...
\todo[inline]{Comment on the assumptions. Basically standard. Which ones are for the CLT? Assumption (e) is the homoskedasticity assumption: it only places an asymptotic restriction. Proof of following is standard and hence omitted. Just substitute DGP, use Lindeberg-Feller, and $L_2$ WLLN. Only step worth commenting on is checking the Lindeberg condition.}
...
\todo[inline]{Comment on the asymptotics. See how OLS has a lower variance for sure but is asymptotically biased unless $\tau = 0$.}
...
\todo[inline]{In this example we're choosing overidentifying restrictions}
