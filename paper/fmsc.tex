...
We begin by defining moment average estimators in general and considering some examples.
...
The same as true for the $J$-test statistic, as we see from the following result. 
