...
The asymptotics of consistent selection, however, give the misleading impression that this effect can be ignored.
In constrast, the asymptotics of conservative selection procedures under local mis-specification provide a far more accurate picture, and can be exploited to construct valid confidence intervals post-selection.
