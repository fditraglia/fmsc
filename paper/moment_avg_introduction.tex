...
It is to this problem that we now direct our attention.

Although the sampling distributions of post-selection estimators are complicated, the key to understanding them is surprisingly simple.
...
Hence, it follows a \emph{mixture} distribution that may be highly non-normal.
