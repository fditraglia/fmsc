...
Because it chooses a \emph{single} specification with probability approaching one in the limit, consistent selection gives us no way to represent this non-normality in the limit distribution.
In constrast, conservative selection procedures remain random \emph{even in the limit}, allowing us to derive a non-normal limit distribution.
