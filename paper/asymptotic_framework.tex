...
The $g$--block of moment conditions contains the ``baseline'' assumptions that an empirical researcher would be prepared to defend in a seminar while the $h$--block contains a set of stronger, more controversial assumptions.
These stronger assumptions are not wildly implausible -- otherwise there would be no reason to entertain them -- but they are at least somewhat dubious.
