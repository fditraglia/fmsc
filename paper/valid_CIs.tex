...
\centering
	\begin{subtable}{0.48\textwidth}
		...
		\input{../OLSvsIVsim/coverage_FMSC_correct.tex}
	\end{subtable}	
	~
	\begin{subtable}{0.48\textwidth}
		\caption{AMSE-Averaging Estimator}
		\input{../OLSvsIVsim/coverage_AVG_correct.tex}
	\end{subtable}
...
\centering
	\begin{subtable}{0.48\textwidth}
		...
		\input{../OLSvsIVsim/coverage_TSLS.tex}
	\end{subtable}	
	~
	\begin{subtable}{0.48\textwidth}
		\caption{Na\"{i}ve post-FMSC}
		\input{../OLSvsIVsim/coverage_FMSC_naive.tex}
	\end{subtable}
...
\centering
	\begin{subtable}{0.48\textwidth}
		\caption{post-FMSC Estimator}
		\input{../OLSvsIVsim/width_FMSC_correct.tex}
	\end{subtable}	
	~
	\begin{subtable}{0.48\textwidth}
		\caption{AMSE-Averaging Estimator}
		\input{../OLSvsIVsim/width_AVG_correct.tex}
	\end{subtable}
