...
Tables \ref{tab:OLSvsIVsim_width_AVG} \ref{tab:OLSvsIVsim_width_FMSC} compare the median width of the two-step post-FMSC interval and the minimum-AMSE interval to that of the 2SLS estimator in the OLS verus 2SLS simulation experiment.
...
We see that moment selection is not a free lunch: the averaging and post-selection intervals are indeed wider than those of the 2SLS estimator, sometimes considerably so.
