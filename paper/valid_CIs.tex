...
\centering
	...
	\end{subtable}
	\caption{Median CI width of conservative intervals relative to that of 2SLS (\%)}
\end{table}
...
\centering
	...
	\end{subtable}
	\caption{Median CI width of conservative intervals relative to that of Valid estimator. (\%)}
\end{table}