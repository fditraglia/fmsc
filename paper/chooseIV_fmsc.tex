...
\todo[inline]{Correct this explanation! We in fact use $\widehat{\beta}_S$ and $\mathbf{z}_{i,S}$. That is, we use the centered, heteroskedasticity-consistent variance matrix estimator based on the residuals of specification $S$ itself!}
\begin{equation}
