...
This is the approach I follow here, as do \cite{Liao} and \cite{ChengLiao}.\footnote{For a dicussion of why Assumption \ref{assump:Identification} is necessary and how one could proceed when it fails, see Appendix \ref{sec:digress}.}
