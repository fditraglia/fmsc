...
Selection and averaging are not a panacea, but in settings where the suspect moment conditions are expected to be at least \emph{approximately} correct a priori, the methods presented in this paper can provide substantial gains, as demonstrated in the simulation results presented below.
...
Section \ref{sec:simulations} presents simulation results and Section \ref{sec:application} considers an empirical example from development economics, exploring the effect of instrument selection on the estimated relationship between malaria transmission and per capita income.
