...
#This script tests out my most recent changes to the simulation study, which include allowing the sample size to vary, and calculating coverage probabilities.
...
write.csv(results, "test_sim_results.csv", row.names = FALSE)
