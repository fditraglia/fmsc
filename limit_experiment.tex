...
Unlike its 2-Step counterpart, this interval comes with no generic theoretical guarantees, so I use the characterization from above to study its limiting behavior. 
