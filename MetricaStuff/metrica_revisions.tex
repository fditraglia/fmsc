...
\begin{eqnarray}
  ...
  X &=&  Z \Pi + \mathbf{v}
\end{eqnarray}
where $Z = (Z_1, Z_2)$ and $\Pi = (\Pi_1', \Pi_2')'$. The local mis-specification assumption is given by
\begin{equation}
...
\todo[inline]{Need to use Cholesky factorization for $Q_z$ and some properties about $\Xi_S$. For example, I think it's true that $\Xi\Xi' = I$ (in other words, that it has orthogonal columns) but I need to check this. This should simplify}
