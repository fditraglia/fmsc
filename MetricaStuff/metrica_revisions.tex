...
Mardia, Kent \& Bibby (1980).

\paragraph{Canonical Correlation Analysis} This discussion follows Mardia, Kent \& Bibby (1980). Let $\mathbf{x}$ be a random $q$-vector and and $\mathbf{y}$ be a random $p$-vector with variance-covariance matrix
