...
where $Q_z = \lim_{n\rightarrow \infty}E_n[\mathbf{z}_i \mathbf{z}_i']$ and we have used the fact that $E_n[\mathbf{v}_i \mathbf{z}_i'] = 0$. It follows that
  ...
  \end{eqnarray*}
\todo[inline]{Now incorporate this along with the CLT into a proposition that gives the limiting distribution for the choosing instruments example. Add limit distribution for the estimator of $\tau$.}
