...
Hall \& Peixe (2003) and Jana (2005). Mardia, Kent \& Bibby (1980).

\paragraph{Canonical Correlation Analysis} Let $\mathbf{x}$ be a random $q$-vector and and $\mathbf{y}$ be a random $p$-vector with variance-covariance matrix
...
The Lagrangian for this problem is
  $$\mathcal{L}(\textbf{b}, \lambda_b; \textbf{a}) = \textbf{b}'\left(\Sigma_{yx} \textbf{a}\textbf{a}' \Sigma_{xy} \right)\textbf{b} - \lambda_b \textbf{b}'\left(\Sigma_{yy} \right)\textbf{b}$$
