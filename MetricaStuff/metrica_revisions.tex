...
Letting $z_{\alpha/2}$ denote the $\alpha/2$ quantile of a standard normal distribution,
  $$\widehat{\tau} \pm z_{\alpha/2} \; \sqrt{\widehat{\sigma}^2_\epsilon \widehat{\sigma}^2_x \left(\frac{\widehat{\sigma}_x^2}{\widehat{\gamma}^2} - 1 \right)}$$
is a $(1-\alpha) \times 100\%$ asymptotic confidence interval for $\tau$.
