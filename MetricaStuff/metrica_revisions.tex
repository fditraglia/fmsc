...
But selection is a blunt instrument. A better idea is to \emph{combine} the OLS and 2SLS estimator by taking a weighted average and choose the weights to minimize AMSE. The problem is 
  ...
  and accordingly
    \begin{eqnarray*}
      ...
      &=& \omega^2 \left(\frac{\tau^2}{\sigma_x^4} \right) + (2\omega - \omega^2)\left(\frac{\sigma_\epsilon^2}{\sigma_x^2}\right)\left(\frac{\sigma_v^2}{\mathbf{\pi}'Q_z\mathbf{\pi}}\right) + \frac{\sigma_\epsilon^2}{\gamma^2}\\
  ...
  Substituting the definitions of $a$ and $b$ we have
    \begin{eqnarray*}
      \omega^* &=& \left[ 1 - \frac{a}{b}\right]^{-1}\\
          ...
          &=& \left[ 1 - \left(\frac{ \mathbf{\pi}'Q_z \mathbf{\pi} }{\sigma_v^2}\right) \left(\frac{\tau^2}{\sigma_x^2\sigma_\epsilon^2}\right)\right]^{-1}\\
          &=& \left[ 1 - \left(\frac{ \mathbf{\pi}'Q_z \mathbf{\pi} }{\sigma_x^2}\right) \left(\frac{\tau^2}{\sigma_v^2\sigma_\epsilon^2}\right)\right]^{-1}\\
          &=& \left[ 1 - \left(\frac{ \mathbf{\pi}'Q_z \mathbf{\pi} }{\mathbf{\pi}'Q_z \mathbf{\pi}}\right) \left(\frac{\tau^2}{\sigma_v^2\sigma_\epsilon^2}\right)\right]^{-1}
    \end{eqnarray*}
