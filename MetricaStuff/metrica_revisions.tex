...
where
    ...
    1 \\ -1
    \end{array}\right]\\
        &=& (\sigma_\epsilon^2/\sigma_x^2)(\sigma_x^2/\gamma^2 - 1)  \\
        &=&(\sigma_\epsilon^2/\sigma_x^2)(\sigma_v^2/\gamma^2) = (\sigma_\epsilon^2 \sigma_v^2)/(\sigma_x^2\gamma^2)
    \end{eqnarray*}
Hence,
  \begin{eqnarray*}
...
Now we will show that the test statistic for the Durbin-Hausman-Wu test is \emph{numerically identical} to the ``test statistic'' view of the FMSC for this problem.
...
But selection is a blunt instrument. A better idea is to \emph{combine} the OLS and 2SLS estimator by taking a weighted average and choose the weights to minimize AMSE. The problem is 
  ...
  so the first order condition for a minimum is
    \begin{eqnarray*}
      ...
      \omega^* &=& \frac{1}{1 - a/b}
    \end{eqnarray*}
    The second order condition for a minimum is is $2(a-b) > 0$ which is equivalent to $a > b$. Now, 
    \begin{eqnarray*}
       ...
       b &=& \frac{\sigma_\epsilon^2}{\kappa^2 \sigma_x^2} = \sigma_\epsilon^2\left[ \frac{1}{\sigma_x^2} \left(\frac{1}{\kappa^2}\right)\right] = \sigma_\epsilon^2\left[ \frac{1}{\sigma_x^2} \left(\frac{\sigma_v^2}{\boldsymbol{\pi}'Q_z \boldsymbol{\pi}}\right)\right] \\
          &=&  \sigma_\epsilon^2\left[ \frac{1}{\sigma_x^2} \left(\frac{\sigma_x^2 - \boldsymbol{\pi}'Q_z \boldsymbol{\pi}}{\boldsymbol{\pi}'Q_z \boldsymbol{\pi}}\right)\right]=\sigma_\epsilon^2\left[ \frac{1}{\sigma_x^2} \left(\frac{\sigma_x^2 }{\boldsymbol{\pi}'Q_z \boldsymbol{\pi}}-1\right)\right]\\
          &=&\sigma_\epsilon^2\left[ \frac{1}{\boldsymbol{\pi}'Q_z \boldsymbol{\pi}}- \frac{1}{\sigma_x^2}\right] = \frac{\sigma_\epsilon^2}{\gamma} - \frac{\sigma_\epsilon^2}{\sigma_x^2} = \mbox{AVAR(2SLS) - AVAR(OLS)}
     \end{eqnarray*} 

  Substituting the definitions of $a$ and $b$ we have
    \begin{eqnarray*}
      \omega^* &=& \left[ 1 - \frac{a}{b}\right]^{-1}\\
          &=& \left[ 1 - \left(\frac{\tau^2}{\sigma_x^4}\right)\left(\frac{\kappa^2 \sigma_x^2}{\sigma_\epsilon^2}\right)\right]^{-1}\\
          &=& \left[ 1 - \kappa^2 \left(\frac{\tau^2}{\sigma_x^2\sigma_\epsilon^2}\right)\right]^{-1}\\
          &=& \left[ 1 - \left(\frac{ \boldsymbol{\pi}'Q_z \boldsymbol{\pi} }{\sigma_v^2}\right) \left(\frac{\tau^2}{\sigma_x^2\sigma_\epsilon^2}\right)\right]^{-1}\\
          &=& \left[ 1 - \left(\frac{ \boldsymbol{\pi}'Q_z \boldsymbol{\pi} }{\sigma_x^2}\right) \left(\frac{\tau^2}{\sigma_v^2\sigma_\epsilon^2}\right)\right]^{-1}\\
          &=& \left[ 1 - \left(\frac{ \boldsymbol{\pi}'Q_z \boldsymbol{\pi} }{\boldsymbol{\pi}'Q_z \boldsymbol{\pi} + \sigma_v^2}\right) \left(\frac{\tau^2}{\sigma_v^2\sigma_\epsilon^2}\right)\right]^{-1}\\
          &=& \left[ 1 - R^2 \left(\frac{\tau^2}{\sigma_v^2\sigma_\epsilon^2}\right)\right]^{-1}\\
          &=& \left[1 - \left(\frac{\kappa^2}{1 + \kappa^2} \right)\left(\frac{\tau^2}{\sigma_v^2 \sigma_\epsilon^2}\right) \right]^{-1}
    \end{eqnarray*}
