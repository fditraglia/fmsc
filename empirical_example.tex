...
The positive-part FMSC sets a negative squared asymptotic bias estimate to zero when estimating AMSE.\footnote{I use a similar construction to ensure that the estimated weight is between zero and one in Section \ref{sec:momentavgexample}.}
