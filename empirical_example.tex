...
Table \ref{tab:FMSC_values} presents FMSC and positive-part FMSC results for instrument sets 1--8.\footnote{For a discussion of the positive-part FMSC and its performance in simulations, see \ref{sec:chooseIVsim}.}
