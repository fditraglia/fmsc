...
lapply(names(cover.panels), function(x) cat(cover.panels[[x]], file = paste0("coverage_", x, ".tex")))
...
lapply(names(width.panels), function(x) cat(width.panels[[x]], file = paste0("width_", x, ".tex")))
