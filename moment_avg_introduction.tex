...
In the remainder of this section, I derive the asymptotic distribution of generic ``moment average'' estimators and use them to propose simulation-based procedures for post-moment selection estimators. 
