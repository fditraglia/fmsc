...
The key point is that the post-selection estimator is a \emph{randomly-weighted average} of the individual candiate estimators, some of which are centered away from $\theta_0$.
