...
compute.criteria <- function(X, y, Z1, Z2){
	...
	#Estimated Variance for b1 (valid model estimate) based on S1
	...
	out <- data.frame(b, b.var, J, GMM.AIC, GMM.BIC, GMM.HQ, CC.AIC, CC.BIC, CC.HQ, FMSC, b1, b1.var, J1, GMM.AIC.1, GMM.BIC.1, GMM.HQ.1, CC.AIC.1, CC.BIC.1, CC.HQ.1, FMSC.1)
