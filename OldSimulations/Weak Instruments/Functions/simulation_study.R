#Updated November 28, 2011 -- Now the first stage coefficients are 0.01 rather than 0.1 to induce a weak instruments problem
...
simulation.study <- function(N.reps, sample.size, relevance.w, endog.w){
	...
	for(i in  1:N.reps){
		...
		sim <- linear.simulation(relevance.w, endog.w, N = sample.size, p1 = 0.01, p2 = 0.01, p3 = 0.01)
