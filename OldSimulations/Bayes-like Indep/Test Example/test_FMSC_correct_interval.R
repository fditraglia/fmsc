...
#This script tests out a quasi-Bayesian version of the two-stage correct confidence interval. 
...
#outfilename <- "sim_results_avg_test.csv"
output.dir <- './Test Run'
...
root.dir <- "C:/Documents and Settings/rt356/My Documents/My Dropbox/PhD Dissertation/Job Market Paper/Simulations/Bayes-like Indep"

outfile.name <- "FMSC_bayes_conf_N_500_test.csv"
