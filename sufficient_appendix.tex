%!TEX root = main.tex
\section{Low-Level Sufficient Conditions}
\label{sec:sufficient_conditions}

\begin{assump}[Sufficient Conditions for Theorem \ref{thm:OLSvsIV}]
...
\begin{assump}[Sufficient Conditions for Theorem \ref{thm:chooseIV}.]
